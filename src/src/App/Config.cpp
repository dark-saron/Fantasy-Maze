...
#include "src/Extern/json/reader.h"
...
{
    char* filename = "GameData/Dungeon/CellTypes.dat";
...
{
    char* filename = "GameData/Dungeon/CharactereTypes.dat";
...
{
    char filename[40];
    char* formatLevel = "GameData/Dungeon/Level%i.lvl";
